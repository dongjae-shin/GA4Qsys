...
cell = slab.get_cell()
p0 = np.array([0., 0., max(pos[:, 2]) + 2.]) # maybe the height of cluster
v1 = cell[0, :] * 0.8
v2 = cell[1, :] * 0.8
v3 = cell[2, :]
v3[2] = 3.
...
# DJ: it extracts atoms numbers from slab and atoms on slab, without double
# counting
